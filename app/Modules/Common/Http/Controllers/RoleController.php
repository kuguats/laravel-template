...
class RoleController extends Controller
{
    ...
    {
        return View::make('Common::role.index');
    }
    ...
    {
        return View::make('Common::role.create');
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('Common::role.edit',compact('role'));
    }
    ...
    public function permission(Request $request,$id)
    {
        ...
        return View::make('Common::role.permission',compact('role','permissions'));
    }
