...
class UserController extends Controller
{
    ...
    {
        return View::make('Common::user.login');
    }
    ...
    {
        return View::make('Common::user.changeMyPassword');
    }
    ...
    {
        return View::make('Common::user.index');
    }
    ...
    {
        return View::make('Common::user.create');
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('Common::user.edit',compact('user'));
    }
    ...
    public function role($id)
    {
        ...
        return View::make('Common::user.role',compact('roles','user'));
    }
    ...
    public function permission($id)
    {
        ...
        return View::make('Common::user.permission',compact('user','permissions'));
    }
