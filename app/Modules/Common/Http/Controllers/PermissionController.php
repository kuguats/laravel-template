...
class PermissionController extends Controller
{
    ...
    {
        return View::make('Common::permission.index');
    }
    ...
    public function create()
    {
        ...
        return View::make('Common::permission.create', compact('permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        $permissions = Permission::with('children')->where('parent_id', 0)->get();
        return View::make('Common::permission.edit', compact('permission', 'permissions'));
    }
